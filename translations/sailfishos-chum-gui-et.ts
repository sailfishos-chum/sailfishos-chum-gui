...
<context>
    ...
    <message id="chum-setings-override-release-description">
        ...
        <translation>&lt;b&gt;Muudatuse kinnitamiseks vajuta &lt;kbd&gt;Sisestusklahvi&lt;/kbd&gt;&lt;/b&gt;&lt;br /&gt;Tavaliselt valitakse vajalik SailfishOS:Chum tarkvarahoidla automaatselt sinu nutiseadmes kasutusel oleva Sailfish&amp;nbsp;OS&apos;i versiooni alusel. Kui soovid SailfishOS:Chum tarkvarahoidla valida mingi konkreetse Sailfish&amp;nbsp;OS&apos;i versiooni jaoks, siis saad seda teha kirjutades siia soovitud versiooni numbri (näiteks &lt;i&gt;4.3.0.12&lt;/i&gt;). Sellisest võimalusest on kasu, kui SailfishOS:Chum tarkvarahoidla pole antud Sailfish&amp;nbsp;OS&apos;i versiooni jaoks saadaval. Nii võib näiteks juhtuda Sailfish&amp;nbsp;OS&apos;i beetaversiooni kasutajatel.</translation>
    </message>
    ...
    <message id="chum-about-description">
        ...
        <translation>&amp;nbsp;1Kogukonna poolt hallatav SailfishOS:Chum tarkvarahoidla on kogumik rakendusi, tarvikuid ja teeke, mis on kompileeritud erineva raudvara ja Sailfish&amp;nbsp;OS&apos;i versioonide jaoks.23Kui Jolla Store ja OpenRepos rakendustepoodidesse laadivad arendajad eelnevalt kompileeritud rakendused, siis kõik SailfishOS:Chum tarkvarahoidlast leitav tarkvara on kompileeritud ja RPM&apos;idena pakendatud korratava kompileerimise põhimõtete alusel otse lähtekoodist. Kõik selleks vajaliku lähtekoodi lisavad arendajad veebiteenusesse OBS (Open Build Service), misjärel luuakse vajalikud RPM-failid erinevate raudvara ja Sailfish&amp;nbsp;OS versioonide jaoks.45Selline metoodika tagab, et kõikide meie tarkvarahoidlas leiduvate tarkvarapakettide kogu lähtekood on alati avalikult leitav ning kontrollitav ja kõik tarkvarapaketid on loodud ainult selle lähtekoodi alusel. Mistõttu kõik tarkvarapaketid SailfishOS:Chum tarkvarahoidlas on alati loodud läbipaistval ja jälgitaval viisil.67Kuna me kasutame tarkvara jaoks ühte ja ühist automaatset kompileerimisteenust, siis arendajate töö on muutunud tõhusamaks ja mugavamaks - jagatud teekide haldamisele kulub vähem aega, topelttöö jääb tegemata, teegid on alati uuendatud ning on palju lihtsam tuvastada tarkvarakomponente, mis on olemas ja mis veel on Sailfish&amp;nbsp;OS OBS&apos;ist puudu. Lisaks on palju kergem jälgida paljude ja tihtipeale mitmekihiliste abiteekide ja sõltuva tarkvara olekuid - see ülioluline võimalus aga tagab et kõik meie teenusest leitav tarkvara läbi kogu oma sõltuvusahela kasutab alati kõikide komponentide õigeid versioone.89SailfishOS:Chum tarkvarahoidla asub veebiteenuses Sailfish&amp;nbsp;OS OBS:1011build.merproject.org/project/show/sailfishos:chum111213Kui soovid ingliskeelse sõna &amp;quot;chum&amp;quot; algupära ja tähendusi teada, siis vaata neid kahte veebilehte: 14en.wikipedia.org:Chumming14 ja 15en.wiktionary.org:chum15.</translation>
    </message>
